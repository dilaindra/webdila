...
import Photo2 from '../images/instagram.png'
...
export default function footer() {
  return (
    <div>
      <footer aria-label="Site Footer" class="bg-[815B5B] text-center">
          ...
          <div class="mx-auto max-w-3xl space-y-0">
            <div class="flex justify-center gap-6">
              <a
                ...
                href="https://www.twitter.com/indrasastraaa"
                target="_blank"
                rel="noreferrer"
                aria-label="Twitter"
              >
                {/* <img
                  alt="Trainer"
                  src={Photo2}
                  class="mt-0 h-7 w-7 object-cover"
                /> */}
            ...
            ></path> */}
              ...
              <a
                ...
                href="https://www.instagram.com/indrasastradimadja"
                target="_blank"
                rel="noreferrer"
              ...
              <a
                ...
                href="https://www.tiktok.com/@indrasastradimadja"
                target="_blank"
                rel="noreferrer"
                aria-label="Tiktok"
              >
            ...
            <p class="mx-auto max-w-lg text-xs text-gray-500">
              Website ini dibuat menggunakan ReactJS dengan bantuan TailWind

              <span class="mt-2 block"> &copy; 2022 Dila </span>
            </p>
          </div>
        </div>
      </footer>
